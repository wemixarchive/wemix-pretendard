...
for suffix, file_replacements in zip(file_suffixes, file_replacements_list):
    file_path = os.path.join(folder_path, f'WEMIXPretendardJP{suffix}.ttx')
